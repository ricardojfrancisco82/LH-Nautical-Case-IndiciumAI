...
* Quantos produtos duplicados foram removidos? *11*
...
* Carregue o arquivo JSON e gere um novo arquivo CSV organizando-o de acordo com a definição na imagem Questão 3 figura 1. ok
...
* Quantas entradas de importação o CSV recebeu ao todo após a normalização? *1260*
